                    ...
                    while (!backmenu){
                        ...
                        switch (airlineOption){
                            case 1:
                                ...
                                //se instancia un avion para pasarle el constructor del controlador y pasarle el avion al metodo create
                            ...
                            case 2:
                                //Eliminar avion
                                int airlineId = Integer.parseInt(JOptionPane.showInputDialog("Ingrese el id del avion que desea eliminar"));
                    ...
                    while (!backmenu1){
                        ...
                        switch (flightOption){
                            case 1:
                                ...
                                Date departureDate = Date.valueOf(JOptionPane.showInputDialog("Ingrese la fecha de salida"));
                                Time departureTIme = Time.valueOf(JOptionPane.showInputDialog("Ingrese la hora de salida"));
                                int idAirline = Integer.parseInt(JOptionPane.showInputDialog("Ingrese el ID del avion"));
                                ...
                                break;
                            case 2:
                                int idFlight = Integer.parseInt(JOptionPane.showInputDialog("Ingrese el id del vuelo a eliminar"));
                                ...
                                break;
                            case 3:
                                String destinationFlight = JOptionPane.showInputDialog("Ingrese el destino para saber los vuelos");
                        ...
                        switch (userOption){
                            case 1:
                                ...
                                if (createPassenger != null ){
                                    JOptionPane.showMessageDialog(null, "Pasajero creado con exito: " + createPassenger);
                                }else {
                            ...
                            case 2:
                                //ELiminar usuarios
                                int passangerID = Integer.parseInt(JOptionPane.showInputDialog("Ingrese el id del usuario a eliminar"));
                            ...
                            case 3:
                                //Buscar usuarios
                                String name = JOptionPane.showInputDialog("Ingrese el nombre de los pasajeros a buscar");
                ...
                case 4:
                    ...
                    while (!backmenu3){
                        ...
                        switch (reservationOption){
                            case 1:
                                int idPassenger = Integer.parseInt(JOptionPane.showInputDialog("Ingrese el id del pasajero a reservar"));
                                Date dateReservation = Date.valueOf(JOptionPane.showInputDialog("Ingrese la fecha de la reservacion"));
                                ...
                                Reservation reservation = new Reservation(0, idPassenger, dateReservation, idFlight, seat);
                                Reservation createReservation = reservationController.create(reservation);
                                if (createReservation != null ){
                                    JOptionPane.showMessageDialog(null, "reservacion creado con exito: " + createReservation);
                                }else {
                            ...
                            case 2:
                                int idReservation = Integer.parseInt(JOptionPane.showInputDialog("Ingrese el id de la reservacion para eliminar"));
                                boolean deleteReservation = reservationController.delete(idReservation);
                                if (deleteReservation){
                                    JOptionPane.showMessageDialog(null, "Reserva eliminado con exito.");
                                }else {
